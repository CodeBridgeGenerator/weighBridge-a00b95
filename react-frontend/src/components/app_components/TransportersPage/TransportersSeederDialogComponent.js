...
import seederData from "./transporters.seeder.json";
...
const TransportersSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(TransportersSeederDialogComponent);
