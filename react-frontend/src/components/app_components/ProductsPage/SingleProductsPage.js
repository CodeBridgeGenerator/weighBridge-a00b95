  ...
  const copyPageLink = () => {
    ...
    return (
        ...
        <div className="col-12 flex flex-column align-items-center">
            ...
            <div className="col-12 md:col-6 lg:col-3"><label className="text-sm text-gray-600">Product Code</label><p className="m-0 ml-3" >{Number(_entity?.productCode)}</p></div>
...
<div className="col-12 md:col-6 lg:col-3"><label className="text-sm text-gray-600">VAT</label><p className="m-0 ml-3" >{_entity?.vat}</p></div>
...
<div className="col-12 md:col-6 lg:col-3"><label className="text-sm text-gray-600">Weight</label><p className="m-0 ml-3" >{_entity?.weight}</p></div>
