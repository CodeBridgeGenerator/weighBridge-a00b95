...
import seederData from "./gradings.seeder.json";
...
const GradingsSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(GradingsSeederDialogComponent);
