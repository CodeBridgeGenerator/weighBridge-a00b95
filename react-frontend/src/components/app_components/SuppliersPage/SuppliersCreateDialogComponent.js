...
const SuppliersCreateDialogComponent = (props) => {
    ...
    const onSave = async () => {
        if(!validate()) return;
        let _data = {
            supplierCode: _entity?.supplierCode,supplierName: _entity?.supplierName,company: _entity?.company,addressOne: _entity?.addressOne,addressTwo: _entity?.addressTwo,addressThree: _entity?.addressThree,postcode: _entity?.postcode,telephone: _entity?.telephone,fax: _entity?.fax,mpobCertificateNumber: _entity?.mpobCertificateNumber,certificateName: _entity?.certificateName,expiryDate: _entity?.expiryDate,plantedHa: _entity?.plantedHa,yop: _entity?.yop,uploadCertificate: _entity?.uploadCertificate,
    ...
    return (
        <Dialog header="Create Suppliers" visible={props.show} closable={false} onHide={props.onHide} modal style={{ width: "40vw" }} className="min-w-max scalein animation-ease-in-out animation-duration-1000" footer={renderFooter()} resizable={false}>
            ...
            <span className="align-items-center">
                ...
                <InputNumber id="supplierCode" className="w-full mb-3 p-inputtext-sm" value={_entity?.supplierCode} onChange={(e) => setValByKey("supplierCode", e.value)}  />
            </span>
...
<div className="col-12 md:col-6 field">
            <span className="align-items-center">
                ...
                <InputNumber id="postcode" className="w-full mb-3 p-inputtext-sm" value={_entity?.postcode} onChange={(e) => setValByKey("postcode", e.value)}  />
            </span>
            <small className="p-error">
...
<div className="col-12 md:col-6 field">
            <span className="align-items-center">
                ...
                <InputNumber id="mpobCertificateNumber" className="w-full mb-3 p-inputtext-sm" value={_entity?.mpobCertificateNumber} onChange={(e) => setValByKey("mpobCertificateNumber", e.value)}  />
            </span>
            <small className="p-error">
...
<div className="col-12 md:col-6 field">
            <span className="align-items-center">
                ...
                <InputNumber id="plantedHa" className="w-full mb-3 p-inputtext-sm" value={_entity?.plantedHa} onChange={(e) => setValByKey("plantedHa", e.value)}  />
            </span>
            <small className="p-error">
