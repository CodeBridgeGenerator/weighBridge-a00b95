...
import seederData from "./drivers.seeder.json";
...
const DriversSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(DriversSeederDialogComponent);
