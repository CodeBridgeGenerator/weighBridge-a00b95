...
import seederData from "./incoming.seeder.json";
...
const IncomingSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(IncomingSeederDialogComponent);
