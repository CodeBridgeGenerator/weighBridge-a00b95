...
const SingleOutgoingPage = (props) => {
  ...
  const [isHelpSidebarVisible, setHelpSidebarVisible] = useState(false);
    ...
    useEffect(() => {
        ...
        client
            .service("outgoing")
            .get(urlParams.singleOutgoingId, { query: { $populate: [            {
                path: "createdBy",
                service: "users",
                select: ["name"],
              },{
    ...
    }, [props,urlParams.singleOutgoingId]);
    ...
    return (
        ...
        <div className="col-12 flex flex-column align-items-center">
            <div className="col-12">
                ...
                {/* <p>outgoing/{urlParams.singleOutgoingId}</p> */}
            </div>
...
<div className="col-12 md:col-6 lg:col-3"><label className="text-sm text-gray-600">Second Weight</label><p className="m-0 ml-3" >{Number(_entity?.secondWeight)}</p></div>
...
<div className="col-12 md:col-6 lg:col-3"><label className="text-sm text-gray-600">Net Weight</label><p className="m-0 ml-3" >{Number(_entity?.netWeight)}</p></div>
      ...
      <CommentsSection
        recordId={urlParams.singleOutgoingId}
        user={props.user}
        alert={props.alert}
...
export default connect(mapState, mapDispatch)(SingleOutgoingPage);
