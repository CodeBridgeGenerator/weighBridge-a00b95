...
const OutgoingEditDialogComponent = (props) => {
...
netWeight: _entity?.netWeight,
        ...
        const result = await client.service("outgoing").patch(_entity._id, _data);
        props.onHide();
        props.alert({ type: "success", title: "Edit info", message: "Info outgoing updated successfully" });
    ...
    return (
        <Dialog header="Edit Outgoing" visible={props.show} closable={false} onHide={props.onHide} modal style={{ width: "40vw" }} className="min-w-max scalein animation-ease-in-out animation-duration-1000" footer={renderFooter()} resizable={false}>
            <div className="grid p-fluid overflow-y-auto"
            style={{ maxWidth: "55vw" }} role="outgoing-edit-dialog-component">
...
<div className="col-12 md:col-6 field">
            <span className="align-items-center">
                ...
                <InputNumber id="secondWeight" className="w-full mb-3 p-inputtext-sm" value={_entity?.secondWeight} onChange={(e) => setValByKey("secondWeight", e.value)}  useGrouping={false}/>
            </span>
            <small className="p-error">
...
<div className="col-12 md:col-6 field">
            <span className="align-items-center">
                ...
                <InputNumber id="netWeight" className="w-full mb-3 p-inputtext-sm" value={_entity?.netWeight} onChange={(e) => setValByKey("netWeight", e.value)}  useGrouping={false}/>
            </span>
            <small className="p-error">
...
export default connect(mapState, mapDispatch)(OutgoingEditDialogComponent);
