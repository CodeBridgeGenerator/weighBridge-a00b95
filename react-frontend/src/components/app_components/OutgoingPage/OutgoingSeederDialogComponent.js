...
import seederData from "./outgoing.seeder.json";
...
const OutgoingSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(OutgoingSeederDialogComponent);
