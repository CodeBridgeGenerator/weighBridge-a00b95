...
<div className="col-12 md:col-6 lg:col-3"><label className="text-sm text-gray-600">Vehicle Description</label><p className="m-0 ml-3" >{_entity?.vehicleDescription}</p></div>
<div className="col-12 md:col-6 lg:col-3"><label className="text-sm text-gray-600">Vehicle Registration Number</label><p className="m-0 ml-3" >{_entity?.vehicleRegistrationNumber}</p></div>
