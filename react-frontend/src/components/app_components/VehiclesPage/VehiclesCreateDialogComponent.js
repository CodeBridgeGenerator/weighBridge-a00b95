...
const VehiclesCreateDialogComponent = (props) => {
    ...
    const onSave = async () => {
        if(!validate()) return;
        let _data = {
            vehicleNumber: _entity?.vehicleNumber,vehicleDescription: _entity?.vehicleDescription,vehicleRegistrationNumber: _entity?.vehicleRegistrationNumber,transporter: _entity?.transporter,
