...
const SingleEstatesPage = (props) => {
  ...
  const [isHelpSidebarVisible, setHelpSidebarVisible] = useState(false);
    ...
    useEffect(() => {
        ...
        client
            .service("estates")
            .get(urlParams.singleEstatesId, { query: { $populate: [            {
                path: "createdBy",
                service: "users",
                select: ["name"],
              },{
    ...
    }, [props,urlParams.singleEstatesId]);
    ...
    return (
        ...
        <div className="col-12 flex flex-column align-items-center">
            <div className="col-12">
                ...
                {/* <p>estates/{urlParams.singleEstatesId}</p> */}
            </div>
            <div className="card w-full">
                <div className="grid ">

            <div className="col-12 md:col-6 lg:col-3"><label className="text-sm text-gray-600">Estate Code</label><p className="m-0 ml-3" >{_entity?.estateCode}</p></div>
...
<div className="col-12 md:col-6 lg:col-3"><label className="text-sm text-gray-600">Company Name</label><p className="m-0 ml-3" >{_entity?.companyName}</p></div>
...
<div className="col-12 md:col-6 lg:col-3"><label className="text-sm text-gray-600">Remark</label><p className="m-0 ml-3" >{_entity?.remark}</p></div>
      ...
      <CommentsSection
        recordId={urlParams.singleEstatesId}
        user={props.user}
        alert={props.alert}
        serviceName="estates"
      />
...
export default connect(mapState, mapDispatch)(SingleEstatesPage);
