...
import seederData from "./estates.seeder.json";
...
const EstatesSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(EstatesSeederDialogComponent);
