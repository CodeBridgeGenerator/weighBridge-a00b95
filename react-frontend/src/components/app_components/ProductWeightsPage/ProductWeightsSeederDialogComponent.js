...
import seederData from "./productWeights.seeder.json";
...
const ProductWeightsSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(ProductWeightsSeederDialogComponent);
