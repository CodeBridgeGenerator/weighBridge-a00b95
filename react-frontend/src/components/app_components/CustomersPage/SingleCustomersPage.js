  ...
  const copyPageLink = () => {
    ...
    return (
        ...
        <div className="col-12 flex flex-column align-items-center">
            ...
            <div className="col-12 md:col-6 lg:col-3"><label className="text-sm text-gray-600">Customer Code</label><p className="m-0 ml-3" >{_entity?.customerCode}</p></div>
...
<div className="col-12 md:col-6 lg:col-3"><label className="text-sm text-gray-600">Address 1</label><p className="m-0 ml-3" >{_entity?.address1}</p></div>
<div className="col-12 md:col-6 lg:col-3"><label className="text-sm text-gray-600">Address 2</label><p className="m-0 ml-3" >{_entity?.address2}</p></div>
<div className="col-12 md:col-6 lg:col-3"><label className="text-sm text-gray-600">Address 3</label><p className="m-0 ml-3" >{_entity?.address3}</p></div>
<div className="col-12 md:col-6 lg:col-3"><label className="text-sm text-gray-600">NPWP Number</label><p className="m-0 ml-3" >{_entity?.npwpNumber}</p></div>
