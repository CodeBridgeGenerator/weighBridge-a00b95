...
import seederData from "./cropDeductions.seeder.json";
...
const CropDeductionsSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(CropDeductionsSeederDialogComponent);
