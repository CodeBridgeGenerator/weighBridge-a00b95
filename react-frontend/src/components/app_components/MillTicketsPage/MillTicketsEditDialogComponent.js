...
const MillTicketsEditDialogComponent = (props) => {
    ...
    const onSave = async () => {
        let _data = {
            estateWbTicketNumber: _entity?.estateWbTicketNumber,
estateName: _entity?.estateName,
estateDoNumber: _entity?.estateDoNumber,
millTicketNumber: _entity?.millTicketNumber,
millReceivedTime: _entity?.millReceivedTime,
millDespatchTime: _entity?.millDespatchTime,
estateWeight: _entity?.estateWeight,
millWeight: _entity?.millWeight,
millRejectedWeight: _entity?.millRejectedWeight,
penalty: _entity?.penalty,
oer: _entity?.oer,
cropHarvestedBy: _entity?.cropHarvestedBy,
        };

        setLoading(true);
        try {
            
        const result = await client.service("millTickets").patch(_entity._id, _data);
        props.onHide();
        props.alert({ type: "success", title: "Edit info", message: "Info millTickets updated successfully" });
    ...
    return (
        <Dialog header="Edit Mill Tickets" visible={props.show} closable={false} onHide={props.onHide} modal style={{ width: "40vw" }} className="min-w-max scalein animation-ease-in-out animation-duration-1000" footer={renderFooter()} resizable={false}>
            <div className="grid p-fluid overflow-y-auto"
            style={{ maxWidth: "55vw" }} role="millTickets-edit-dialog-component">
...
<div className="col-12 md:col-6 field">
            <span className="align-items-center">
                ...
                <InputNumber id="millTicketNumber" className="w-full mb-3 p-inputtext-sm" value={_entity?.millTicketNumber} onChange={(e) => setValByKey("millTicketNumber", e.value)}  useGrouping={false}/>
            </span>
            <small className="p-error">
...
<div className="col-12 md:col-6 field">
            <span className="align-items-center">
                ...
                <InputNumber id="millReceivedTime" className="w-full mb-3 p-inputtext-sm" value={_entity?.millReceivedTime} onChange={(e) => setValByKey("millReceivedTime", e.value)}  useGrouping={false}/>
            </span>
            <small className="p-error">
...
<div className="col-12 md:col-6 field">
            <span className="align-items-center">
                ...
                <InputNumber id="millDespatchTime" className="w-full mb-3 p-inputtext-sm" value={_entity?.millDespatchTime} onChange={(e) => setValByKey("millDespatchTime", e.value)}  useGrouping={false}/>
            </span>
            <small className="p-error">
...
<div className="col-12 md:col-6 field">
            <span className="align-items-center">
                ...
                <InputNumber id="estateWeight" className="w-full mb-3 p-inputtext-sm" value={_entity?.estateWeight} onChange={(e) => setValByKey("estateWeight", e.value)}  useGrouping={false}/>
            </span>
            <small className="p-error">
...
<div className="col-12 md:col-6 field">
            <span className="align-items-center">
                ...
                <InputNumber id="millWeight" className="w-full mb-3 p-inputtext-sm" value={_entity?.millWeight} onChange={(e) => setValByKey("millWeight", e.value)}  useGrouping={false}/>
            </span>
            <small className="p-error">
...
<div className="col-12 md:col-6 field">
            <span className="align-items-center">
                ...
                <InputNumber id="millRejectedWeight" className="w-full mb-3 p-inputtext-sm" value={_entity?.millRejectedWeight} onChange={(e) => setValByKey("millRejectedWeight", e.value)}  useGrouping={false}/>
            </span>
            <small className="p-error">
...
<div className="col-12 md:col-6 field">
            <span className="align-items-center">
                ...
                <InputNumber id="oer" className="w-full mb-3 p-inputtext-sm" value={_entity?.oer} onChange={(e) => setValByKey("oer", e.value)}  useGrouping={false}/>
            </span>
            <small className="p-error">
            {!_.isEmpty(error["oer"]) && (
...
export default connect(mapState, mapDispatch)(MillTicketsEditDialogComponent);
