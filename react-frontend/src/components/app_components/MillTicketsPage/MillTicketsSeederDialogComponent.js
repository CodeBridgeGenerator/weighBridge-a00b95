...
import seederData from "./millTickets.seeder.json";
...
const MillTicketsSeederDialogComponent = (props) => {
...
export default connect(mapState, mapDispatch)(MillTicketsSeederDialogComponent);
