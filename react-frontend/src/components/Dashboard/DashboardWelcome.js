    ...
    <ProjectLayout>
      <div className="flex flex-col bg-white">
        <div className="flex flex-col mt-0 mr-0 w-full max-md:mt-10 max-md:max-w-full">
          <div className="flex w-full bg-indigo-50 min-h-[296px] min-w-[1300px] items-center px-12 max-md:px-5">
            {/* Image Section */}
            <img
              loading="lazy"
            ...
            <div className="flex flex-col pl-10">
              <div className="flex flex-col text-slate-700">
                ...
                <p className="mt-4 text-base leading-6">
                  <p className="mt-4 text-base leading-6">
                    Welcome to the ~cb-project-label~ - your centralized platform for managing users, profiles, and projects with ease.
                  </p>
                </p>
              </div>
