...
const createModel = require("../../models/outgoing.model");
...
module.exports = function (app) {
  ...
  app.use("/outgoing", new Outgoing(options, app));

  // Get our initialized service so that we can register hooks
  const service = app.service("outgoing");

  // Get the schema of the collections 
  app.get("/outgoingSchema", function (request, response) {
