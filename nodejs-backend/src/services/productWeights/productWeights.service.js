const { ProductWeights } = require("./productWeights.class");
const createModel = require("../../models/productWeights.model");
const hooks = require("./productWeights.hooks");
...
module.exports = function (app) {
  ...
  app.use("/productWeights", new ProductWeights(options, app));

  // Get our initialized service so that we can register hooks
  const service = app.service("productWeights");

  // Get the schema of the collections 
  app.get("/productWeightsSchema", function (request, response) {
