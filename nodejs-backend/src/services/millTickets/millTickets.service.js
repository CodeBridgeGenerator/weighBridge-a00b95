const { MillTickets } = require("./millTickets.class");
const createModel = require("../../models/millTickets.model");
const hooks = require("./millTickets.hooks");
...
module.exports = function (app) {
  ...
  app.use("/millTickets", new MillTickets(options, app));

  // Get our initialized service so that we can register hooks
  const service = app.service("millTickets");

  // Get the schema of the collections 
  app.get("/millTicketsSchema", function (request, response) {
