const { Gradings } = require("./gradings.class");
const createModel = require("../../models/gradings.model");
const hooks = require("./gradings.hooks");
...
module.exports = function (app) {
  ...
  app.use("/gradings", new Gradings(options, app));

  // Get our initialized service so that we can register hooks
  const service = app.service("gradings");

  // Get the schema of the collections 
  app.get("/gradingsSchema", function (request, response) {
