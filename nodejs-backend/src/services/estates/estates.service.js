const { Estates } = require("./estates.class");
const createModel = require("../../models/estates.model");
const hooks = require("./estates.hooks");
...
module.exports = function (app) {
  ...
  app.use("/estates", new Estates(options, app));

  // Get our initialized service so that we can register hooks
  const service = app.service("estates");

  // Get the schema of the collections 
  app.get("/estatesSchema", function (request, response) {
