const { Transporters } = require("./transporters.class");
const createModel = require("../../models/transporters.model");
const hooks = require("./transporters.hooks");
...
module.exports = function (app) {
  ...
  app.use("/transporters", new Transporters(options, app));

  // Get our initialized service so that we can register hooks
  const service = app.service("transporters");

  // Get the schema of the collections 
  app.get("/transportersSchema", function (request, response) {
