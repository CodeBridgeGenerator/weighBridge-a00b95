const { CropDeductions } = require("./cropDeductions.class");
const createModel = require("../../models/cropDeductions.model");
const hooks = require("./cropDeductions.hooks");
...
module.exports = function (app) {
  ...
  app.use("/cropDeductions", new CropDeductions(options, app));

  // Get our initialized service so that we can register hooks
  const service = app.service("cropDeductions");

  // Get the schema of the collections 
  app.get("/cropDeductionsSchema", function (request, response) {
