...
secondWeight: { type:  String , minLength: 1, maxLength: 1000, index: true, trim: true, comment: "Second Weight, p, false, true, true, true, true, true, true, , , , ," },
